...
static landmarks::LandmarkMap map;               // map of cylinders
...
int main(int argc, char** argv)
{
  ...
  ros::Publisher circle_pub = node_handle.advertise<landmarks::LandmarkMap>("landmarks", 1);
